    ...
    <div className="container py-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-12 mt-12">
        <div className="flex justify-center items-center gap-3">
          ...
          <p className="text-xl font-semibold">Reservas Online</p>
        </div>
        <div className="flex justify-center items-center gap-3">
          <MdOutlineFastfood className="text-2xl" />
          <p className="text-xl font-semibold">Entregas rapidas</p>
        </div>
        <div className="flex justify-center items-center gap-3">
          <MdFoodBank className="text-2xl" />
          <p className="text-xl font-semibold">Pizzas personalizables</p>
        </div>
        <div className="flex justify-center items-center gap-3">
